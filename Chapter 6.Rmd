...
such as strikes. They can be the result of unusually good (The movie E.T. and Reese's Pieces Candy) or unusually
bad (Tylenol poisoning) publicity about a product.

In Figure 16 below, an irregular variation occurs around period 30 as the series drops abruptly and then returns to its upward trend.
...
The astute reader may have noticed that we used the 12-Period Centered Moving Average to assist in calculating the seasonal component, not the OLS linear trend used in our initial example. The 12-Period Centered Moving Average discussed on page 12 offers a dynamic, tighter fit for measuring the monthly Sales trend that includes both a trend and cyclical component. This a topic we will cover in future chapters as we ascend the learning curve. For now, the reader is left to consider combining trend & cylical components into one variable, captured through smoothing the actual time series.
...
Period Observation  Period Observation
1 95  13 118 2 100  14 86 3 87  15 86 4 123  16 112 5 90  17 85 6 96  18 101 7 75  19 135 8 78  20 120 9 106  21 76 10 104  22 115 11 89  23 90 12 83  24 92
...
4. De-seasonalizing Data   
The following 24 observations of quarterly data contain trend and seasonality. 
 Period  Quarter Actual Period  Quarter Actual  t Q Y   t  Q Y > > > >
  1 1 409   13  1 349  2 2 415   14  2 350  3 3 468   15  3 443  4 4 261   16  4 315  5 1 308   17  1 362  6 2 326   18  2 411  7 3 431   19  3 447  8 4 254   20  4 295  9 1 346   21  1 310  10 2 370   22  2 368  11 3 430   23  3 442  12 4 290   24  4 302
a. Plot the data.  
...
Period Observation  Period Observation
1 60  13 89 2 70  14 120 3 85  15 134 4 60  16 121 5 88  17 93 6 68  18 113 7 106  19 125 8 75  20 136 9 86  21 142 10 124  22 117 11 122  23 132 12 87  24 141
...
d. Determine the 95% confidence intervals of forecast for periods 25 to 30. e. What is the MSE of the forecasting model?
