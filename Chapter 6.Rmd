...
The 4-period Centered Moving Average Smoothing is especially suited for
quarterly time series. However, the Centered Moving Average Smoothing formula may be
generalized to any even number of periods.
...
For example, a 3-period Centered Weighted Moving Average, denoted CWMA 3).
