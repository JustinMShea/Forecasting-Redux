...
```{r, message=FALSE, error=FALSE, comment=FALSE, warning=FALSE, echo=FALSE, fig.width = 10, fig.height = 5, fig.fullwidth = TRUE}
ggdraw(switch_axis_position(chart_63 + theme_tufte() +
...
Below is a graphs of the actual values with smoothing.
...
chart_642 <- ggplot(data = table_642_chart, aes(y = Value, x = Period, col = Series)) +
  geom_line(position = "jitter") +
  ggtitle("Actual ~ Centered Moving Average(3,5)") 
