...
Given an economic time series as shown in Figure 6-1 one of the most common approaches to understanding such data is through _classical time series decomposition_. The composition of the time series is decomposed into four components: trend, cyclical, seasonal, and irregular components. 


\textcolor{red}{The components can be either added together or multiplied by each other to define a time series}.  
...
display_table_69 <- rbind(table_69_med, table_69_median_tbl)
row.names(c("Year 1, Year 2, Year 3, Year 4, Median"))

kable(display_table_69, caption = "Ratios of Actual Sales to CWMA(12) Smoothing, Unadjusted Seasonal Index - Median Value", now.names = TRUE)
...
$$Irregular_t = \frac{Sales_t}{Trend_t \times Seasonal_t}$$
