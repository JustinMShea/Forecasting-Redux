...
Below is a graph of actual values with a 5-period smoothing superimposed. The following graph adds an additiona 3-period smoothing for comparison.
...
The cyclical component of a time series at each time step $t$, denoted $C_t$, and illustrated below in Figure 12 and 13, are the broad up-and-down swings of the series around it's trend
