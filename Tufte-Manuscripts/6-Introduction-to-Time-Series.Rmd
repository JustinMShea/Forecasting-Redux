...
ggdraw(figure_61 + theme(panel.background = element_rect(fill = "white", colour = "grey50")))
```
...
ggdraw(figure_621 + theme(panel.background = element_rect(fill = "white", colour = "grey50")))
```
...
ggdraw(figure_622 + theme(panel.background = element_rect(fill = "white", colour = "grey50")))
```
...
chart_63 + theme(panel.background = element_rect(fill = "white", colour = "grey50"), legend.position = "top")
```
...
margin_chart_64 <- ggplot(data = table_641_chart, aes(y = Value, x = Period, col = Series)) +
                   ...
                   scale_y_continuous(breaks=seq(300,400,10), limits = c(300,400), sec.axis = dup_axis()) +
                   scale_x_continuous(breaks=seq(0,35,5), limits = c(0,35)) 
#ggdraw(margin_chart_64 + theme(panel.background = element_rect(fill = "white", colour = "grey50") + theme(legend.position = "top"))
# chart 2
...
ggdraw(chart_642 + theme(panel.background = element_rect(fill = "white", colour = "grey50"), legend.position = "top"))
```
...
ggdraw(chart_65 + theme(panel.background = element_rect(fill = "white", colour = "grey50"), legend.position = "top"))
```
\medskip
...
ggdraw(chart_66 + theme(panel.background = element_rect(fill = "white", colour = "grey50") , legend.position = "top"))
```
...
ggdraw(chart_67 + theme(panel.background = element_rect(fill = "white", colour = "grey50") , legend.position = "top"))
```
...
ggdraw(figure_610 + theme(panel.background = element_rect(fill = "white", colour = "grey50"), legend.position = "top"))
```
...
ggdraw(figure_611 + theme(panel.background = element_rect(fill = "white", colour = "grey50"), legend.position = "top"))
```
...
# draw
ggdraw( figure_69 + theme(panel.background = element_rect(fill = "white", colour = "grey50"), legend.position = "top"))
```
...
ggdraw( figure_614 + theme(panel.background = element_rect(fill = "white", colour = "grey50"), legend.position = "top"))
```
...
# Call graphics Device to illustrate chart
ggdraw(figure_Irregular_series + theme(panel.background = element_rect(fill = "white", colour = "grey50"), legend.position = "top"))
```
...
ggdraw(figure_smooth_c + theme(panel.background = element_rect(fill = "white", colour = "grey50"), legend.position = "top"))
```
